...
const SwapOperation = () => {
  ...
  const handleSwap = async (credentials) => {
    try {
      setIsLoading(true);

      const response = await axios.post("/swapPublic", credentials);
